...
const mainenviatureceta = document.querySelector(".mainmainenviatureceta");//envia tu receta main
const linkrecetas1 = document.querySelectorAll(".linkrecetas");//link de recetas en index
const lover = document.querySelector(".linkrecetas:hover");//link de recetas en index
...
boton.addEventListener("click", () => {
    ...
    mainenviatureceta.classList.toggle ("maintema");//envia tu receta main
    linkrecetas1.classList.toggle ("linkrecetastema");//link de recetas en index
    lover.classList.toggle ("linkrecetastema:hover");//link de recetas en index
